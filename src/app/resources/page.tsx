...
const RESOURCES = [
  ...
  { title: "Minor Protection Policy", description: "The safeguards every match must satisfy before contact.", href: "/policy" },
        ...
        <div className="mx-auto max-w-2xl">
          ...
          <div className="mt-8 space-y-4">
            {RESOURCES.map((resource) => {
              const card = (
                <div className="rounded-xl border border-white/10 bg-white/5 p-5 transition hover:border-hallway-gold/40">
